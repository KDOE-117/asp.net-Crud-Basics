...
namespace CRUD_MVC.Controllers
{
    ...
    {
        private readonly FirstCrudContext _context;

        public PersonasController(FirstCrudContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Personas != null ? 
                          ...
                          Problem("Entity set 'FirstCrudContext.Personas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FirstCrudContext.Personas'  is null.");
            }
            var persona = await _context.Personas.FindAsync(id);
            if (persona != null)
            {
